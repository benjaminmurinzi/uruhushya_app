<?php
/**
 * Import Kinyarwanda Questions from Excel
 * 
 * Upload CSV file with Kinyarwanda questions
 * 
            ...
            if ($file_ext === 'csv') {
                ...
                if ($handle) {
                    ...
                    while (($data = fgetcsv($handle)) !== false) {
                        ...
                        try {
                            // Insert question (Kinyarwanda only)
                            $question_sql = "INSERT INTO questions 
                                           (question_text_rw, difficulty_level, course_id, explanation_rw, status, created_at) 
                                           VALUES (?, ?, ?, ?, 'active', NOW())";
                            ...
                            foreach ($choices as $choice) {
                                $choice_sql = "INSERT INTO question_choices 
                                             (question_id, choice_text_rw, is_correct, sort_order, created_at) 
                                             VALUES (?, ?, ?, ?, NOW())";
                    ...
                    if ($imported_count > 0) {
                        $success = "Successfully imported {$imported_count} Kinyarwanda questions!";
                        log_activity(get_user_id(), 'questions_import', "Imported {$imported_count} Kinyarwanda questions");
                    }
                }
            }
        }
...
$courses = db_fetch_all("SELECT course_id, course_name_rw FROM courses WHERE status = 'active' ORDER BY course_name_rw");
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo $lang === 'english' ? 'Import Kinyarwanda Questions' : 'Injiza Ibibazo by\'Ikinyarwanda'; ?> - <?php echo APP_NAME; ?></title>
        ...
        <div class="container">
            <div class="import-card">
                <h1 class="page-title">
                    ...
                    <?php echo $lang === 'english' ? 'Import Kinyarwanda Questions' : 'Injiza Ibibazo by\'Ikinyarwanda'; ?>
                </h1>
                <p class="page-subtitle">
                    <?php echo $lang === 'english' 
                        ? 'Upload a CSV file with Kinyarwanda questions to bulk import' 
                        : 'Ohereza dosiye ya CSV ifite ibibazo by\'Ikinyarwanda'; ?>
                </p>
                ...
                <div class="info-box">
                    ...
                    <ul class="mb-0">
                        ...
                        <li><?php echo $lang === 'english' ? 'Questions will be imported in KINYARWANDA only' : 'Ibibazo bizinjizwa mu KINYARWANDA gusa'; ?></li>
                ...
                <div class="template-section">
                    ...
                    <p class="text-muted">
                        <?php echo $lang === 'english' 
                            ? 'Download the CSV template and fill it with your Kinyarwanda questions' 
                            : 'Kuramo dosiye ya template uyuzuze ibibazo by\'Ikinyarwanda'; ?>
                    </p>
                    <a href="download-template-rw.php" class="btn btn-download-template">
                        <i class="fas fa-file-download"></i> 
                        <?php echo $lang === 'english' ? 'Download Kinyarwanda Template' : 'Kuramo Template y\'Ikinyarwanda'; ?>
                    </a>
                    ...
                    <div class="mt-3">
                        ...
                        <code style="font-size: 12px; background: #fff; padding: 10px; display: block; margin-top: 10px; border-radius: 5px;">
                            ikibazo, igisubizo_a, igisubizo_b, igisubizo_c, igisubizo_d, igisubizo_gikwiye, urwego, icyiciro, ibisobanuro
                        </code>
                    </div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="upload-area">
                        ...
                        <p class="text-muted mb-4">
                            <?php echo $lang === 'english' ? 'Select a CSV file with Kinyarwanda questions' : 'Hitamo dosiye ya CSV ifite ibibazo by\'Ikinyarwanda'; ?>
                        </p>
